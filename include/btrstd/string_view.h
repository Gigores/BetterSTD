...
btr_string_view_s BTR_StringView_cropLeft(btr_string_view_s, unsigned int charCount);
...
btr_string_view_s BTR_StringView_revertLeft(btr_string_view_s, unsigned int charCount);
...
btr_string_view_s BTR_StringView_revertRight(btr_string_view_s, unsigned int charCount);
...
btr_string_view_s BTR_StringView_trimLeft(btr_string_view_s);
// Trims whitespaces from the right of the view.
btr_string_view_s BTR_StringView_trimRight(btr_string_view_s);
// Trims whitespaces from left and right of the view.
btr_string_view_s BTR_StringView_trim(btr_string_view_s);
